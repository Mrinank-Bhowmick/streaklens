  ...
  return (
    <>
      ...
      <aside
        ...
        } bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-navbar-purple dark:border-white`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-navbar-purple">
            ...
            <li>
              ...
              >
                <li>
                  <Link
                    href="/ideator"
                    className={`flex ml-8 items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group ${
